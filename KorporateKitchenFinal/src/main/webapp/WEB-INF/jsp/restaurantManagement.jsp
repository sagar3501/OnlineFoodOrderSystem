...
<table class="restaurant-table table table-hover align-middle">
<thead>
<tr>
...
<tr class="restaurant-row" style="animation-delay: ${loop.index * 0.05}s">
<td class="fw-bold text-primary">${restaurant.restaurantName}</td>
